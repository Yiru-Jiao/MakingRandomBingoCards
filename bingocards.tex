...
\NewDocumentCommand{\setItems}{}
{
	...
	\prg_replicate:nn {25} % generate random list of 24 items
    {
...
\begin{large}
Talk to other people and find someone who matches a description in any square.\\
When you find someone, ask them to sign or write their names/initials in that square.\\
**Each person can only sign one square on your card.**\\
Prizes will be awarded to two winners:\\
1) the first to fill five squares in a row (horizontally, vertically, or diagonally) and yell Bingo!\\
2) the one with the most signatures by the end of the game!
\end{large}
}
...
\newcommand{\Size}{3.6cm}
\newcommand{\Sizeinner}{3.55cm}
