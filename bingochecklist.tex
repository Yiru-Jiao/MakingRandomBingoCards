...
\usepackage{marvosym}
% \usepackage{hyperref}      % Required for creating forms and checkboxes
% \usepackage{pifont}        % Required for \ding symbols (e.g., \ding{53})
\usepackage{acroform}      % Optional, if not using hyperref forms directly
